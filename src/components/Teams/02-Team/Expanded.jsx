...
/** Feeder match → next-round slot (02-team expanded bracket). */
...
export default function Expanded(props) {
  ...
  return (
    <>
      <table className={styles.bracketTable} data-theme={props.theme === "dark" ? "dark" : "light"} border={0} cellPadding={0} cellSpacing={0} width={1214}>
