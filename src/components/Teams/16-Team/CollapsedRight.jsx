      ...
      <table border={0} cellPadding={0} cellSpacing={0} width={944} style={{borderCollapse: 'collapse', tableLayout: 'fixed', width: '708pt'}}>
        <colgroup><col width={35} span={5} style={{msoWidthSource: 'userset', msoWidthAlt: 1109, width: '26pt'}} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <td rowSpan={2} className={styles.xl111} style={{borderBottom: '.5pt solid black'}}>TKC A</td>
          </tr>
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td height={20} className={styles.xl65} style={{height: '15.75pt'}} />
            <td className={styles.xl84} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <td rowSpan={2} className={styles.xl111} style={{borderBottom: '.5pt solid black', borderTop: 'none'}}>TKC A</td>
          </tr>
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td height={20} className={styles.xl65} style={{height: '15.75pt'}} />
            <td className={styles.xl84} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <td className={styles.xl99}>&nbsp;</td>
            <td className={styles.xl102}>&nbsp;</td>
            <td rowSpan={2} className={styles.xl85} align="right">10</td>
          </tr>
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <td className={styles.xl84} />
            <td className={styles.xl102}>&nbsp;</td>
            <td rowSpan={2} className={styles.xl99} align="right">12</td>
          </tr>
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td height={20} className={styles.xl65} style={{height: '15.75pt'}} />
            <td className={styles.xl84} />
          ...
          <tr height={21} style={{height: '16.0pt'}}>
            <td height={21} className={styles.xl65} style={{height: '16.0pt'}} />
          </tr>
        </tbody></table>
    </>
  );
