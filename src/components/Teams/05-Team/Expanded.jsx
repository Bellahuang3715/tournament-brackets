...
/** Feeder match → next-round slot (05-team expanded bracket). */
...
export default function Expanded(props) {
  ...
  return (
    <>
      <table className={styles.bracketTable} data-theme={props.theme === "dark" ? "dark" : "light"} border={0} cellPadding={0} cellSpacing={0} width={1690}>
        <colgroup><col width={168} style={{msoWidthSource: 'userset', msoWidthAlt: 5376, width: '122pt'}} />
