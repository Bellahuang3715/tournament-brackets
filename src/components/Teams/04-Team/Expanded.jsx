...
export default function Expanded(props) {
  ...
  return (
    <>
      <table border={0} cellPadding={0} cellSpacing={0} width={1452} style={{borderCollapse: 'collapse', tableLayout: 'fixed', width: '1090pt'}}>
        <colgroup><col width={168} style={{msoWidthSource: 'userset', msoWidthAlt: 5376, width: '126pt'}} />
          ...
          <col width={101} span={8} style={{width: '76pt'}} />
            ...
            <td colSpan={7} height={20} className="xl142" width={644} style={{height: '15.75pt', width: '482pt'}} />
