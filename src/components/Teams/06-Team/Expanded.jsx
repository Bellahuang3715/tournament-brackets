      ...
      <table border={0} cellPadding={0} cellSpacing={0} width={1690} style={{borderCollapse: 'collapse', tableLayout: 'fixed', width: '1268pt'}}>
        <colgroup><col width={168} style={{msoWidthSource: 'userset', msoWidthAlt: 5376, width: '126pt'}} />
          ...
          <col width={101} span={8} style={{width: '76pt'}} />
            ...
            <td height={20} className="xl66" width={168} style={{height: '15.75pt', width: '126pt'}} />
            <td className="xl65" width={35} style={{width: '26pt'}} />
            <td width={35} style={{width: '26pt'}} />
            <td className="xl67" colSpan={4} width={406} style={{msoIgnore: 'colspan', width: '304pt'}}>GROUP
              x-x | COURT x</td>
          ...
          <tr height={21} style={{height: '16.0pt'}}>
            <td height={21} className="xl82" style={{height: '16.0pt'}} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <td className="xl66" />
            <td className="xl66" />
            <td rowSpan={2} className="xl65">5</td>
            <td className="xl71">&nbsp;</td>
            {team(5)}
            <td className="xl66" />
            <td className="xl66" />
