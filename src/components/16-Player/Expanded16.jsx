...
export default function Expanded16() {
  return (
    <>
      <table border={0} cellPadding={0} cellSpacing={0} width={2263} style={{borderCollapse: 'collapse', tableLayout: 'fixed', width: '1697pt'}}>
        <colgroup><col width={57} style={{msoWidthSource: 'userset', msoWidthAlt: 1834, width: '43pt'}} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td rowSpan={2} height={40} className={styles.xl111} style={{borderBottom: '.5pt solid black', height: '31.5pt'}}>#</td>
          ...
          <tr height={20} style={{height: '15.75pt'}}>
            <td colSpan={2} height={20} className={styles.xl116} style={{height: '15.75pt'}}>Name (Club)</td>
            ...
            <td rowSpan={2} className={styles.xl115} style={{borderBottom: '.5pt solid black'}}>&nbsp;</td>
            <td className={styles.xl65} />
            <td className={styles.xl66} />
            <td className={styles.xl66} />
            <td className={styles.xl66} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td rowSpan={2} height={40} className={styles.xl111} style={{borderBottom: '.5pt solid black', height: '31.5pt', borderTop: 'none'}}>&nbsp;</td>
            <td rowSpan={2} className={styles.xl113} style={{borderBottom: '.5pt solid black', borderTop: 'none'}}>&nbsp;</td>
          ...
          <tr height={20} style={{height: '15.75pt'}}>
            <td colSpan={2} height={20} className={styles.xl116} style={{height: '15.75pt'}} />
            <td className={styles.xl65} />
            <td className={styles.xl66} />
            <td className={styles.xl66} />
            <td className={styles.xl66} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <td className={styles.xl66} />
            <td className={styles.xl66} />
            <td className={styles.xl77} style={{borderTop: 'none'}}>&nbsp;</td>
            <td className={styles.xl74}>&nbsp;</td>
            <td />
            <td className={styles.xl66} />
            <td className={styles.xl66} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <td rowSpan={2} className={styles.xl114} style={{borderBottom: '.5pt solid black'}}>&nbsp;</td>
            <td rowSpan={2} className={styles.xl77} style={{borderBottom: '.5pt solid black'}}>&nbsp;</td>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <td className={styles.xl66} />
            <td className={styles.xl66} />
            <td rowSpan={2} className={styles.xl65}>15</td>
          ...
          <tr height={20} style={{height: '15.75pt'}}>
            ...
            <td className={styles.xl66} />
            <td className={styles.xl66} />
            <td className={styles.xl84} style={{borderTop: 'none'}}>&nbsp;</td>
            <td className={styles.xl66} />
            <td className={styles.xl66} />
            <td className={styles.xl66} />
            <td className={styles.xl66} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td rowSpan={2} height={37} className={styles.xl111} style={{borderBottom: '.5pt solid black', height: '28.75pt', borderTop: 'none'}}>&nbsp;</td>
            <td rowSpan={2} className={styles.xl113} style={{borderBottom: '.5pt solid black', borderTop: 'none'}}>&nbsp;</td>
            <td className={styles.xl75}>&nbsp;</td>
            <td className={styles.xl69} />
            <td colSpan={2} style={{msoIgnore: 'colspan'}} />
          ...
          <tr height={17} style={{height: '13.0pt'}}>
            <td height={17} className={styles.xl65} style={{height: '13.0pt'}} />
            <td className={styles.xl69} />
            <td className={styles.xl66} />
            <td className={styles.xl66} />
            <td className={styles.xl65} />
          ...
          <tr height={21} style={{height: '16.0pt'}}>
            <td colSpan={2} height={21} className={styles.xl116} style={{height: '16.0pt'}} />
            <td className={styles.xl65} />
            <td className={styles.xl66} />
            <td colSpan={2} style={{msoIgnore: 'colspan'}} />
            <td className={styles.xl65} />
          ...
          <tr height={17} style={{height: '13.0pt'}}>
            <td height={17} colSpan={2} style={{height: '13.0pt', msoIgnore: 'colspan'}} />
            <td className={styles.xl65} />
            <td colSpan={3} style={{msoIgnore: 'colspan'}} />
            <td className={styles.xl65} />
            <td className={styles.xl66} />
          ...
          <tr height={17} style={{height: '13.0pt'}}>
            <td rowSpan={2} height={34} className={styles.xl111} style={{borderBottom: '.5pt solid black', height: '26.0pt'}}>&nbsp;</td>
            <td rowSpan={2} className={styles.xl113} style={{borderBottom: '.5pt solid black'}}>&nbsp;</td>
            <td className={styles.xl68}>&nbsp;</td>
            <td className={styles.xl69} />
            <td className={styles.xl65} />
          ...
          <tr height={17} style={{height: '13.0pt'}}>
            <td height={17} className={styles.xl70} style={{height: '13.0pt'}}>&nbsp;</td>
            <td className={styles.xl69} />
            <td className={styles.xl65} />
            <td className={styles.xl65} />
            <td className={styles.xl65} />
          ...
          <tr height={17} style={{height: '13.0pt'}}>
            <td height={17} className={styles.xl72} style={{height: '13.0pt'}}>&nbsp;</td>
            <td className={styles.xl72}>&nbsp;</td>
            <td className={styles.xl73}>&nbsp;</td>
            <td className={styles.xl74}>&nbsp;</td>
            <td className={styles.xl66} />
          ...
          <tr height={17} style={{height: '13.0pt'}}>
            <td rowSpan={2} height={34} className={styles.xl111} style={{borderBottom: '.5pt solid black', height: '26.0pt', borderTop: 'none'}}>&nbsp;</td>
            <td rowSpan={2} className={styles.xl113} style={{borderBottom: '.5pt solid black', borderTop: 'none'}}>&nbsp;</td>
            <td className={styles.xl75}>&nbsp;</td>
            <td className={styles.xl69} />
            <td className={styles.xl66} />
