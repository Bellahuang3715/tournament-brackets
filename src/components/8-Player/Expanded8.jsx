...
export default function Expanded8() {
  return (
    <>
      <table border={0} cellPadding={0} cellSpacing={0} width={1892} style={{borderCollapse: 'collapse', tableLayout: 'fixed', width: '1420pt'}}>
        <colgroup><col width={57} style={{msoWidthSource: 'userset', msoWidthAlt: 1834, width: '43pt'}} />
          ...
          <col width={101} span={8} style={{width: '76pt'}} />
            ...
            <td className={styles.xl66} width={168} style={{width: '126pt'}} />
            <td className={styles.xl65} width={35} style={{width: '26pt'}} />
            <td width={35} style={{width: '26pt'}} />
            <td width={49} style={{width: '37pt'}} />
            <td className={styles.xl67} colSpan={5} width={455} style={{msoIgnore: 'colspan', width: '341pt'}}>GROUP
              x-x | COURT x</td>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <td rowSpan={2} className={styles.xl110} style={{borderBottom: '.5pt solid black'}}>&nbsp;</td>
            <td className={styles.xl65} />
            <td className={styles.xl66} />
            <td className={styles.xl66} />
            <td className={styles.xl66} />
          ...
          <tr height={20} style={{height: '15.75pt'}}>
            <td colSpan={2} height={20} className={styles.xl71} style={{height: '15.75pt'}}>Name (Club)</td>
            <td rowSpan={2} className={styles.xl65}>1</td>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td height={20} className={styles.xl65} style={{height: '15.75pt'}} />
            <td className={styles.xl66} />
            <td className={styles.xl73} style={{borderTop: 'none'}}>&nbsp;</td>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td height={20} className={styles.xl77} style={{height: '15.75pt', borderLeft: 'none'}}>&nbsp;</td>
            <td className={styles.xl66} />
            <td className={styles.xl66} />
            <td className={styles.xl66} />
            <td className={styles.xl76}>&nbsp;</td>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td colSpan={2} height={20} className={styles.xl78} style={{height: '15.75pt'}} />
            <td className={styles.xl65} />
            <td className={styles.xl66} />
            <td className={styles.xl66} />
            <td className={styles.xl66} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td colSpan={2} height={20} className={styles.xl80} style={{height: '15.75pt'}} />
          ...
          <tr height={20} style={{height: '15.75pt'}}>
            <td colSpan={2} height={20} className={styles.xl119} style={{height: '15.75pt'}} />
            <td className={styles.xl65} />
            <td className={styles.xl66} />
            <td className={styles.xl66} />
            <td className={styles.xl66} />
