      ...
      <table border={0} cellPadding={0} cellSpacing={0} width={1001} style={{borderCollapse: 'collapse', tableLayout: 'fixed', width: '751pt'}}>
        <colgroup><col width={57} style={{msoWidthSource: 'userset', msoWidthAlt: 1834, width: '43pt'}} />
          ...
          <tr height={21} style={{height: '16.0pt'}}>
            <td colSpan={2} height={21} className={styles.playerName} style={{height: '16.0pt'}}>{`${players[0].name} (${players[0].club})`}</td>
          ...
          <tr height={21} style={{height: '16.0pt'}}>
            <td colSpan={2} height={21} className={styles.playerName} style={{height: '16.0pt'}}>{`${players[8].name} (${players[8].club})`}</td>
          </tr>
          <tr height={24} style={{height: '18.0pt'}}>
            <td height={24} className={styles.xl01} style={{height: '18.0pt'}} />
            <td className={styles.xl01} />
          ...
          <tr height={21} style={{height: '16.0pt'}}>
            <td colSpan={2} height={21} className={styles.playerName} style={{height: '16.0pt'}}>{`${players[9].name} (${players[9].club})`}</td>
          </tr>
        </tbody></table>
    </>
  );
