...
export default function CollapsedRight10({ players }) {
  return (
    <>
      <table border={0} cellPadding={0} cellSpacing={0} width={799} style={{borderCollapse: 'collapse', tableLayout: 'fixed', width: '599pt'}}>
