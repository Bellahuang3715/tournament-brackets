...
/** Feeder match → next-round slot (12-player expanded bracket). Configure manually. */
...
export default function Expanded(props) {
  ...
  return (
    <>
      <table className={styles.bracketTable} data-theme={props.theme === "dark" ? "dark" : "light"} border={0} cellPadding={0} cellSpacing={0} width={2188}>
        <colgroup>
