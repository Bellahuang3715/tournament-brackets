...
export default function CollapsedRight({
  ...
  return (
    <>
      <table border={0} cellPadding={0} cellSpacing={0} width={900} style={{borderCollapse: 'collapse', tableLayout: 'fixed', width: 'fit-content', maxWidth: '100%'}}>
        ...
        <tbody>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td height={20} className={styles.borderRightBottom} style={{height: '15.75pt'}} />
