      ...
      <table border={0} cellPadding={0} cellSpacing={0} width={2289} style={{borderCollapse: 'collapse', tableLayout: 'fixed', width: '1717pt'}}>
        <colgroup><col width={57} style={{msoWidthSource: 'userset', msoWidthAlt: 1834, width: '43pt'}} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <ScoreRowFillable 
              player={players[28]}
              onScoreChange={handleScoreChange(28)}
              onIDChange={handleIDChange(28)}
              playerIDStyle={playerIDStyle}
            />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <NameRowFillable
              player={players[28]}
              onNameChange={handleNameChange(28)}
              playerNameStyle={playerNameStyle}
            />
            <td className={styles.xl00} />
            <td className={styles.borderLeft}>&nbsp;</td>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <ScoreRowFillable 
              player={players[30]}
              onScoreChange={handleScoreChange(30)}
              onIDChange={handleIDChange(30)}
              playerIDStyle={playerIDStyle}
            />
          </tr>
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <NameRowFillable
              player={players[30]}
              onNameChange={handleNameChange(30)}
              playerNameStyle={playerNameStyle}
            />
          </tr>
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <ScoreRowFillable 
              player={players[29]}
              onScoreChange={handleScoreChange(29)}
              onIDChange={handleIDChange(29)}
              playerIDStyle={playerIDStyle}
            />
            <td className={styles.borderRight}>&nbsp;</td>
          </tr>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <NameRowFillable
              player={players[29]}
              onNameChange={handleNameChange(29)}
              playerNameStyle={playerNameStyle}
            />
          </tr>
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <ScoreRowFillable 
              player={players[27]}
              onScoreChange={handleScoreChange(27)}
              onIDChange={handleIDChange(27)}
              playerIDStyle={playerIDStyle}
            />
            <td className={styles.borderRightBottom}>&nbsp;</td>
          </tr>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <NameRowFillable
              player={players[27]}
              onNameChange={handleNameChange(27)}
              playerNameStyle={playerNameStyle}
            />
          </tr>
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
