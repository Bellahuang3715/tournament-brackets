...
export default function Expanded16({ players }) {
  return (
    <>
      <table border={0} cellPadding={0} cellSpacing={0} width={2289} style={{borderCollapse: 'collapse', tableLayout: 'fixed', width: '1717pt'}}>
        <colgroup><col width={57} style={{msoWidthSource: 'userset', msoWidthAlt: 1834, width: '43pt'}} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td colSpan={2} height={20} className={styles.playerNameExpanded} style={{height: '15.75pt'}}>{`${players[2].name} (${players[2].club})`}</td>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <td className={styles.borderLeft}>&nbsp;</td>
            <td rowSpan={2} className={styles.playerIDExpanded} style={{borderBottom: '.5pt solid black'}}>13</td>
            <td rowSpan={2} className={styles.borderTopRight} style={{borderBottom: '.5pt solid black'}}>Score</td>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <td className={styles.borderRight}>&nbsp;</td>
            <td />
            <td colSpan={2} className={styles.playerNameExpanded}>Name 13</td>
            <td className={styles.xl00} />
            <td className={styles.borderLeft}>&nbsp;</td>
          </tr>
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td colSpan={2} height={20} className={styles.playerNameExpanded} style={{height: '15.75pt'}}>{`${players[5].name} (${players[5].club})`}</td>
            <td className={styles.xl00} />
            <td className={styles.xl00} />
            <td className={styles.xl00} />
            <td className={styles.xl00} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <td className={styles.borderBottomLeft} style={{borderLeft: 'none'}}>&nbsp;</td>
            <td rowSpan={2} className={styles.playerIDExpanded} style={{borderBottom: '.5pt solid black'}}>15</td>
            <td rowSpan={2} className={styles.borderTopRight} style={{borderBottom: '.5pt solid black'}}>Score</td>
          </tr>
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <td className={styles.borderRight}>&nbsp;</td>
            <td />
            <td colSpan={2} className={styles.playerNameExpanded}>Name 15</td>
          </tr>
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td colSpan={2} height={20} className={styles.playerNameExpanded} style={{height: '15.75pt'}}>{`${players[8].name} (${players[8].club})`}</td>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td rowSpan={2} height={40} className={styles.playerIDExpanded} style={{borderBottom: '.5pt solid black', height: '31.5pt', borderTop: 'none'}}>{players[9].id}</td>
            <td rowSpan={2} className={styles.borderTopRight} style={{borderBottom: '.5pt solid black', borderTop: 'none'}}>Score</td>
            <td className={styles.borderRightBottom}>&nbsp;</td>
            <td className={styles.xl00} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td rowSpan={2} height={40} className={styles.playerIDExpanded} style={{borderBottom: '.5pt solid black', height: '31.5pt'}}>{players[10].id}</td>
            <td rowSpan={2} className={styles.borderTopRight} style={{borderBottom: '.5pt solid black'}}>Score</td>
            <td className={styles.borderBottom}>&nbsp;</td>
            <td className={styles.xl00} />
            <td className={styles.xl00} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td colSpan={2} height={20} className={styles.playerNameExpanded} style={{height: '15.75pt'}}>{`${players[11].name} (${players[11].club})`}</td>
            <td className={styles.xl00} />
            <td className={styles.xl00} />
            <td colSpan={2} style={{msoIgnore: 'colspan'}} />
            <td className={styles.xl00} />
            ...
            <td className={styles.borderLeft}>&nbsp;</td>
            <td rowSpan={2} className={styles.playerIDExpanded} style={{borderBottom: '.5pt solid black'}}>14</td>
            <td rowSpan={2} className={styles.borderTopRight} style={{borderBottom: '.5pt solid black'}}>Score</td>
            <td className={styles.borderRight}>&nbsp;</td>
          </tr>
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <td className={styles.borderRight}>&nbsp;</td>
            <td />
            <td colSpan={2} className={styles.playerNameExpanded}>Name 14</td>
          </tr>
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td rowSpan={2} height={40} className={styles.playerIDExpanded} style={{borderBottom: '.5pt solid black', height: '31.5pt'}}>{players[12].id}</td>
            <td rowSpan={2} className={styles.borderTopRight} style={{borderBottom: '.5pt solid black'}}>Score</td>
            <td className={styles.borderBottom}>&nbsp;</td>
            <td className={styles.xl00} />
            <td className={styles.xl00} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td colSpan={2} height={20} className={styles.playerNameExpanded} style={{height: '15.75pt'}}>{`${players[12].name} (${players[12].club})`}</td>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td rowSpan={2} height={40} className={styles.playerIDExpanded} style={{borderBottom: '.5pt solid black', height: '31.5pt', borderTop: 'none'}}>{players[13].id}</td>
            <td rowSpan={2} className={styles.borderTopRight} style={{borderBottom: '.5pt solid black', borderTop: 'none'}}>Score</td>
            <td className={styles.borderRightBottom}>&nbsp;</td>
            <td className={styles.xl00} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td colSpan={2} height={20} className={styles.playerNameExpanded} style={{height: '15.75pt'}}>{`${players[13].name} (${players[13].club})`}</td>
            <td className={styles.xl00} />
            <td className={styles.xl00} />
            <td className={styles.xl00} />
            <td className={styles.xl00} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td rowSpan={2} height={40} className={styles.playerIDExpanded} style={{borderBottom: '.5pt solid black', height: '31.5pt'}}>{players[14].id}</td>
            <td rowSpan={2} className={styles.borderTopRight} style={{borderBottom: '.5pt solid black'}}>Score</td>
            <td className={styles.borderBottom}>&nbsp;</td>
            <td className={styles.xl00} />
            <td className={styles.xl00} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td colSpan={2} height={20} className={styles.playerNameExpanded} style={{height: '15.75pt'}}>{`${players[14].name} (${players[14].club})`}</td>
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td rowSpan={2} height={40} className={styles.playerIDExpanded} style={{borderBottom: '.5pt solid black', height: '31.5pt', borderTop: 'none'}}>{players[15].id}</td>
            <td rowSpan={2} className={styles.borderTopRight} style={{borderBottom: '.5pt solid black', borderTop: 'none'}}>Score</td>
            <td className={styles.borderRightBottom}>&nbsp;</td>
            <td className={styles.xl00} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            <td colSpan={2} height={20} className={styles.playerNameExpanded} style={{height: '15.75pt'}}>{`${players[15].name} (${players[15].club})`}</td>
