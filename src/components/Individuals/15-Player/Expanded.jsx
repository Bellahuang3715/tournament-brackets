...
/** Feeder match → next-round slot (15-player expanded bracket). Configure manually. */
...
export default function Expanded(props) {
  ...
  return (
    <>
      <table className={styles.bracketTable} data-theme={props.theme === "dark" ? "dark" : "light"} border={0} cellPadding={0} cellSpacing={0} width={2263}>
        <colgroup><col width={57} style={{msoWidthSource: 'userset', msoWidthAlt: 1834, width: '43pt'}} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <td className={styles.borderRightBottom}>&nbsp;</td>
            <td className={styles.xl00} />
            {/* Round 8 Bottom Player | Index 16 */}
            {nameRow(16)}
            <td className={styles.xl00} />
            <td className={styles.xl00} />
            <td className={styles.xl00} />
          ...
          <tr height={20} style={{msoHeightSource: 'userset', height: '15.75pt'}}>
            ...
            <td className={styles.xl00} />
            <td className={styles.xl00} />
            {/* Round 11 Bottom Player | Index 14 */}
            {scoreRow(14)}
            <td className={styles.borderRightBottom}>&nbsp;</td>
            <td />
            {/* Round 1 Top Player | Index 0 */}
          ...
          <tr height={21} style={{height: '16.0pt'}}>
            ...
            <td className={styles.xl00} />
            <td className={styles.xl00} />
            {/* Round 11 Bottom Player | Index 15 */}
            {nameRow(14)}
            <td className={styles.xl00} />
            <td colSpan={5} style={{msoIgnore: 'colspan'}} />
          </tr>
