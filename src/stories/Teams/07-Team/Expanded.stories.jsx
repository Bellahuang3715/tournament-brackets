...
import Expanded from "../../../components/Teams/07-Team/Expanded";
import { sampleTeams7 } from "../../data/teams";

export default {
  title: "Teams/07-Team/Expanded",
  component: Expanded,
  argTypes: {
...
const Template = (args) => <Expanded {...args} fontFamily={args.teamIDFontFamily} />;
